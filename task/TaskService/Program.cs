...
app.MapPost("/api/task/", async (CreateTask createTask,AppDbContext db,IHttpClientFactory httpFactory) =>
{
    ...
    await client.PostAsJsonAsync("api/webhooks/task_created",NewTask);
